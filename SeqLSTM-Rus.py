...
if __name__ == "__main__":
    ...
    # list to ndarray
    train_dataset = numpy.array(train_dataset).reshape((len(train_dataset), seqLen, len(features)))
    test_dataset = numpy.array(test_dataset).reshape((len(test_dataset), seqLen, len(features)))
